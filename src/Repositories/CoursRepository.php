...
class CoursRepository
{
    ...
    {
        $sql = "SELECT * FROM " . PREFIXE . "cours WHERE id = :id";
    ...
    {
        $sql = "SELECT * FROM " . PREFIXE . "cours WHERE NOM = :nom";
    ...
    {
        $sql = "INSERT INTO " . PREFIXE . "cours (ID,NOM,DEBUT_COURS,FIN_COURS,CODE,ID_PROMO) VALUES (:ID,:NOM,:DEBUT_COURS,:FIN_COURS,:CODE,:ID_PROMO)";
    ...
    {
        try {
            $sql = "DELETE FROM " . PREFIXE . "peut_etre WHERE Id_Cours = :ID;
              DELETE FROM " . PREFIXE . "cours WHERE ID = :ID;";
